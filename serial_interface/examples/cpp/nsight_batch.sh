...
#run the application:
nsys profile --stats=true -t nvtx,openmp -o openMP_code  --force-overwrite=true ./chimescalc ../../../serial_interface/tests/force_fields/published_params.HN3.2+3+4b.Tersoff.special.offsets.txt \
...
/opt/nvidia/hpc_sdk/Linux_x86_64/23.9/profilers/Nsight_Systems/host-linux-x64/QdstrmImporter -i openMP_code.qdstrm