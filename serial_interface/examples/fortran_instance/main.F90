...
! Contributing Author:  Nir Goldman (2020) 
      ...
      character(1024) :: coord_file, param_file, newfile
      ...
      type(C_ptr) :: chimes_ptr = c_null_ptr
      integer lenstr, tester

      small = 1
      chimes_ptr = f_chimes_open_instance()
      ...
      call f_set_chimes_instance(chimes_ptr, small)
      
      print*,"fcheck-1"
      newfile = trim(param_file) // c_null_char
      call f_init_chimes_instance(chimes_ptr, newfile,  0) ! last '0' is the rank of the process
      ...
      call f_calculate_chimes_instance (chimes_ptr, natom, xc, yc, zc, stringPtr, ca,  &
      ...
      enddo
      close(20)
      call f_chimes_close_instance(chimes_ptr)
