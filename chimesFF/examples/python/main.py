"""
	...
	Expects "lib-C_wrapper-serial_inteface.so" in the same directory as this script. This file
...
wrapper_py.chimes_wrapper = wrapper_py.init_chimes_wrapper("lib-C_wrapper-serial_inteface.so")
